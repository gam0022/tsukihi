#ifndef _TSUKIHI_RENDERER_H_
#define _TSUKIHI_RENDERER_H_
...
namespace tsukihi {
	...
	public:
		TsukihiRenderer(double shadowIntensity = 0.1, double shadowSharpness = 30.0, double minDiffuse = 0.1, double minAmbient = 0.1) :
			shadowIntensity(shadowIntensity), shadowSharpness(shadowSharpness), minDiffuse(minDiffuse), minAmbient(minAmbient), Renderer() {}
		Color radiance(const Ray &ray, Random *rnd, const int depth);

		double shadowIntensity, shadowSharpness;
		double minDiffuse, minAmbient;
